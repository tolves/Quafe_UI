...
C.Color.Alliance = {
	{r =  56/255, g = 154/255, b = 254/255},
	{r =  32/255, g =  32/255, b = 164/255},
}

C.Color.Horde = {
	{r = 249/255, g = 154/255, b = 164/255},
	{r = 164/255, g =  32/255, b =  32/255},
}
...
C.Color.B2 = {r =  31/255, g = 174/255, b = 255/255} 
...
C.Font.Num = C.Font.Num or STANDARD_TEXT_FONT
C.Font.Big = C.Font.Big or STANDARD_TEXT_FONT

C.Font.NumOW = F.Path("Fonts\\Teko.ttf")
C.Font.NumOWI = F.Path("Fonts\\Share-Italic.ttf")
C.Font.NumOWII = F.Path("Fonts\\ShareTech.ttf")
